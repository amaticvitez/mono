...
namespace monovitezEnt.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		{
			switch((monovitezEnt.EntityType)typeOfEntity)
			{
		...
		/// <summary>returns the datasource to use in a Linq query when targeting VehicleMakeEntity instances in the database.</summary>
		public DataSource2<VehicleMakeEntity> VehicleMake {	get { return new DataSource2<VehicleMakeEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		...
		public DataSource2<VehicleModelEntity> VehicleModel {	get { return new DataSource2<VehicleModelEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
