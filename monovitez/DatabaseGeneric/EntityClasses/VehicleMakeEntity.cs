...
namespace monovitezEnt.EntityClasses
{
	...
	
	{
		...
		protected class VehicleMakeEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("VehicleMakeEntity", InheritanceHierarchyType.None, false, (int)monovitezEnt.EntityType.VehicleMakeEntity, typeof(VehicleMakeEntity), typeof(VehicleMakeEntityFactory), false);
				AddNavigatorMetaData<VehicleMakeEntity, EntityCollection<VehicleModelEntity>>("VehicleModels", a => a._vehicleModels, (a, b) => a._vehicleModels = b, a => a.VehicleModels, () => new VehicleMakeRelations().VehicleModelEntityUsingMakeId, typeof(VehicleModelEntity), (int)monovitezEnt.EntityType.VehicleModelEntity);
			}
		}
