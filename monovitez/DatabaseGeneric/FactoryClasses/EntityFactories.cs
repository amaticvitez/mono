...
namespace monovitezEnt.FactoryClasses
{
	...
	{
		private readonly monovitezEnt.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, monovitezEnt.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((monovitezEnt.EntityType)entityTypeValue); }
	...
	/// <summary>Factory to create new, empty VehicleMakeEntity objects.</summary>
	[Serializable]
	public partial class VehicleMakeEntityFactory : EntityFactoryBase2<VehicleMakeEntity> 
	{
		/// <summary>CTor</summary>
		public VehicleMakeEntityFactory() : base("VehicleMakeEntity", monovitezEnt.EntityType.VehicleMakeEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new VehicleMakeEntity(fields); }
	}

	/// <summary>Factory to create new, empty VehicleModelEntity objects.</summary>
	[Serializable]
	public partial class VehicleModelEntityFactory : EntityFactoryBase2<VehicleModelEntity> 
	{
		/// <summary>CTor</summary>
		public VehicleModelEntityFactory() : base("VehicleModelEntity", monovitezEnt.EntityType.VehicleModelEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new VehicleModelEntity(fields); }
	}
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(monovitezEnt.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(monovitezEnt.EntityType)))
			{
				var factory = GetFactory((monovitezEnt.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the monovitezEnt.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(monovitezEnt.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case monovitezEnt.EntityType.VehicleMakeEntity:
					return new VehicleMakeEntityFactory();
				case monovitezEnt.EntityType.VehicleModelEntity:
					return new VehicleModelEntityFactory();
				default:
					return null;
			}
		}
	...
	{
		/// <summary>Gets the factory of the Entity type with the monovitezEnt.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (monovitezEnt.EntityType)Enum.Parse(typeof(monovitezEnt.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((monovitezEnt.EntityType)Enum.Parse(typeof(monovitezEnt.EntityType), leftOperandEntityName, false), joinType, (monovitezEnt.EntityType)Enum.Parse(typeof(monovitezEnt.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (monovitezEnt.EntityType)Enum.Parse(typeof(monovitezEnt.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((monovitezEnt.EntityType)entityTypeValue); }
