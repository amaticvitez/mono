...
namespace monovitez.DAL.FactoryClasses
{
	...
	{
		private readonly monovitez.DAL.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, monovitez.DAL.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((monovitez.DAL.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public VehicleMakeEntityFactory() : base("VehicleMakeEntity", monovitez.DAL.EntityType.VehicleMakeEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public VehicleModelEntityFactory() : base("VehicleModelEntity", monovitez.DAL.EntityType.VehicleModelEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(monovitez.DAL.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(monovitez.DAL.EntityType)))
			{
				var factory = GetFactory((monovitez.DAL.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the monovitez.DAL.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(monovitez.DAL.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case monovitez.DAL.EntityType.VehicleMakeEntity:
					return new VehicleMakeEntityFactory();
				case monovitez.DAL.EntityType.VehicleModelEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the monovitez.DAL.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (monovitez.DAL.EntityType)Enum.Parse(typeof(monovitez.DAL.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((monovitez.DAL.EntityType)Enum.Parse(typeof(monovitez.DAL.EntityType), leftOperandEntityName, false), joinType, (monovitez.DAL.EntityType)Enum.Parse(typeof(monovitez.DAL.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (monovitez.DAL.EntityType)Enum.Parse(typeof(monovitez.DAL.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((monovitez.DAL.EntityType)entityTypeValue); }
